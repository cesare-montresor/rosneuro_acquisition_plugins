#ifndef ROSNEURO_ACQUISITION_PLUGIN_DUMMYDEVICE_HPP
#define ROSNEURO_ACQUISITION_PLUGIN_DUMMYDEVICE_HPP
...
PLUGINLIB_EXPORT_CLASS(rosneuro::DummyDevice, rosneuro::Device)
